 ...
 */
export declare class TableViewSettings implements v4.TableSettings {
    type?: v4.TableTypeV4;
    creationMode?: TableCreationMode;
 ...
 */
export declare class LRChartView implements v4.LRChartView {
    key: string;
    index: number;
    annotationPath: string;
    entitySet?: string;
 ...
 */
export declare class LRTableView extends TableViewSettings implements v4.LRTableView {
    key: string;
    index: number;
    annotationPath: string;
