...
function determineTargetAnnotationOfTable(ids, transferParameters, configObject) {
    ...
    const annotationPath = (_a = transferParameters.appSchema.definitions[common_1.DefinitionName.TableSPV]) === null || _a === void 0 ? void 0 : _a[common_1.SchemaTag.annotationPath];
    if (ids.length > 1 && transferParameters.config['table'].annotationPath) {
        const annoPath = (_b = transferParameters.appSchema.definitions[common_1.DefinitionName.ALPTable]) === null || _b === void 0 ? void 0 : _b[common_1.SchemaTag.annotationPath];
        targetAnnotationEncoded = targetAnnotation = annoPath && annoPath.substr(annoPath.lastIndexOf('@'));
    }
    else if ((_c = configObject.table) === null || _c === void 0 ? void 0 : _c.annotationPath) {
        //view definition
...
function determineTargetAnnotationOfChart(ids, transferParameters, targetAnnotationEncoded, targetAnnotation, configObject) {
    var _a, _b;
    if (ids.length > 1) {
        const annoPath = (_a = transferParameters.appSchema.definitions[common_1.DefinitionName.ALPChart]) === null || _a === void 0 ? void 0 : _a[common_1.SchemaTag.annotationPath];
        targetAnnotationEncoded = targetAnnotation = annoPath && annoPath.substr(annoPath.lastIndexOf('@'));
    }
    else {
        //chart level
...
function determineTargetAnnotationOfViews(transferParameters, ids, targetAnnotation, targetAnnotationEncoded) {
    ...
    if (parentDefinition) {
        if (ids.length === 3) {
            ...
            const ownDefinitionName = (_b = parentDefinition.$ref) === null || _b === void 0 ? void 0 : _b.split(common_1.DEFINITION_LINK_PREFIX)[1];
            const ownDefinition = ownDefinitionName && transferParameters.appSchema.definitions[ownDefinitionName];
            const annotation = (ownDefinition === null || ownDefinition === void 0 ? void 0 : ownDefinition[common_1.SchemaTag.annotationPath]) &&
...
function transferSortedListEntry(parameters, parentIds, stableIdParts, preprocessed = false) {
    ...
    const { newElementCreated, stopProcessing } = createNewElement(parameters.index, (_a = parameters.propertyDefinition.$ref) === null || _a === void 0 ? void 0 : _a.split(common_1.DEFINITION_LINK_PREFIX)[1], parameters.key, parameters.configObject, parameters.breadcrumbs, parameters.transferParameters, preprocessed);
...
function mergeEntriesForInsert(transferParameters, additionalProperties, list, configObject) {
    let properties = additionalProperties === null || additionalProperties === void 0 ? void 0 : additionalProperties.properties;
    let required = additionalProperties === null || additionalProperties === void 0 ? void 0 : additionalProperties.required;
    if (!properties && (additionalProperties === null || additionalProperties === void 0 ? void 0 : additionalProperties.$ref)) {
        const reference = additionalProperties === null || additionalProperties === void 0 ? void 0 : additionalProperties.$ref;
...
function transferManifestEntriesAndFlexChange(transferParameters, configObject, parentIds, stableIdParts, breadcrumbs, schemaDefinition) {
    ...
    const anyOfDefinitions = additionalProperties === null || additionalProperties === void 0 ? void 0 : additionalProperties.anyOf;
    ...
    if (sortedList) {
        if ((_a = sortedList[0]) === null || _a === void 0 ? void 0 : _a[1][common_1.SchemaTag.propertyIndex]) {
        ...
        if (additionalProperties === null || additionalProperties === void 0 ? void 0 : additionalProperties.$ref) {
            // Merge new entries for creation into list
...
const exportObjectPage = (exportParameters, ui5Version) => {
    ...
    if ((_a = exportParameters.page.config) === null || _a === void 0 ? void 0 : _a[common_1.PropertyName.sections]) {
...
const exportListPage = (exportParameters, factory, config, pageType, ui5Version, templateType) => {
    ...
    const definitionName = ((_a = config.table) === null || _a === void 0 ? void 0 : _a[common_1.PropertyName.annotationPath]) ? common_1.DefinitionName.ALPTableView
...
const exportApplicationV4 = (application, manifest, appSchema) => {
    ...
    for (const key in appSchema.definitions.AppSettings.properties) {
        ...
        if (syncRule && syncRule.manifest) {
            ...
            if (((_a = application.settings) === null || _a === void 0 ? void 0 : _a[key]) !== undefined) {
