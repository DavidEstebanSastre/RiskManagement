...
function addSelectionFields(entityType, appSchema, selectionFieldsAnnotation) {
    ...
    selectionFieldsAnnotation.forEach((selectionField) => {
        ...
        appSchema['definitions'][fieldDefinition] = Object.assign({ type: 'object', properties: {}, description, annotationPath: `${selectionFieldsDefinition[common_1.SchemaTag.annotationPath]}/${i}`, isViewNode: true, additionalProperties: false, annotationType: selectionField === null || selectionField === void 0 ? void 0 : selectionField.type }, (dataType && { dataType }));
        i++;
    });
}
/**
...
function addALPViews(appSchema, viewsPaths, entityType, generateParameters, templateAnnotation, v4Page, tableDefinitionName) {
    ...
    //1. Chart View
    const chartAnnotationPath = (_c = (_b = (_a = viewsPaths === null || viewsPaths === void 0 ? void 0 : viewsPaths[0]) === null || _a === void 0 ? void 0 : _a['primary']) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c[common_1.SchemaTag.annotationPath];
    ...
    //2. Table View
    const { visualization: tableVisualization, targetAnnotation: target } = analyzeViewAnnotation((_f = (_e = (_d = viewsPaths === null || viewsPaths === void 0 ? void 0 : viewsPaths[0]) === null || _d === void 0 ? void 0 : _d['secondary']) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f[common_1.SchemaTag.annotationPath], annotations, generateParameters, 'secondary');
    ...
    if (annotationTerm) {
        utils_1.addLineItemsType(appSchema, entityType.annotations.UI[annotationTerm], entityType, generateParameters.serviceAVT, common_1.DefinitionName.LineItems, common_1.DefinitionName.ViewTableColumn);
...
function addViewLineItems(inputParameters, viewsDefinition, visualization, templateAnnotation, generateParameters) {
    ...
    const annotationTerm = (visualization === null || visualization === void 0 ? void 0 : visualization.split('.')[1]) || templateAnnotation.split(common_1.UIVOCABULARYDOT)[1];
    utils_1.addLineItemsType(inputParameters.appSchema, inputParameters.targetEntityType.annotations.UI[annotationTerm], inputParameters.targetEntityType, generateParameters.serviceAVT, viewId, common_1.DefinitionName.ViewTableColumn, common_1.DefinitionName.ViewCustomColumn, common_1.DefinitionName.ViewCustomAction);
}
/**
...
function addLRViewParts(visualization, viewsDefinition, commonInputParameters, generateParameters, v4Page, uiAnnotations, view) {
    if ((visualization === null || visualization === void 0 ? void 0 : visualization.indexOf(ux_specification_types_1.Visualization.LineItem)) > -1) {
        //Add Line item view
...
function addLRViews(appSchema, viewsPaths, entityType, entitySet, generateParameters, v4Page, tableDefinitionName) {
    ...
    for (const view of viewsPaths) {
        ...
        const { visualization, targetAnnotation, namespace, title } = analyzeViewAnnotation(view === null || view === void 0 ? void 0 : view[common_1.SchemaTag.annotationPath], uiAnnotations, generateParameters, view[common_1.SchemaTag.key]);
        if (view['entitySet']) {
...
function adaptTableDefinition(appSchema, entityType, generateParameters, templateAnnotation, v4Page, alias, tableDefinitionName) {
    ...
    if (visualization) {
        ...
        const annotationTermQualifier = (_a = annotationTerm.split('#')) === null || _a === void 0 ? void 0 : _a[1];
        ...
        const lineItemAnnotation = (_c = (_b = entityType === null || entityType === void 0 ? void 0 : entityType.annotations) === null || _b === void 0 ? void 0 : _b[alias]) === null || _c === void 0 ? void 0 : _c.LineItem;
        utils_1.addLineItemsType(appSchema, lineItemAnnotation, entityType, generateParameters.serviceAVT, common_1.DefinitionName.LineItems);
        utils_1.addCustomColumnDefinition(appSchema, v4Page, generateParameters.logger);
...
function addTableAndViews(appSchema, v4Page, entityType, entitySet, generateParameters, alias) {
    ...
    if (generateParameters.templateType === common_1.TemplateType.ListReportObjectPageV4) {
        if (viewsPaths) {
            ...
            if (!((_e = (_d = v4Page.options) === null || _d === void 0 ? void 0 : _d.settings) === null || _e === void 0 ? void 0 : _e.views)) {
...
function generateListReportSchemaV4(generateParameters, genericSchema, entitySet, templateName) {
    ...
    const selectionFieldAnnotation = alias && ((_b = (_a = entityType === null || entityType === void 0 ? void 0 : entityType.annotations) === null || _a === void 0 ? void 0 : _a[alias]) === null || _b === void 0 ? void 0 : _b.SelectionFields);
