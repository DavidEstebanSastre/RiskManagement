...
function generateListReportInterfaceV4(templateType, genericSchema, entitySetName, annotations, logger, manifest) {
    ...
    const templateName = templateType === utils_1.TemplateType.ListReportObjectPageV4 ? ux_specification_types_1.v4.FE_TEMPLATE_V4_LIST_REPORT : ux_specification_types_1.v4.FE_TEMPLATE_V4_ALP;
