...
function handleLineItem(facet, facetKey, appSchema, lineItemFacet, oDataServiceAVT, v4Page, logger) {
    ...
    utils_1.addLineItemsType(appSchema, lineItemFacet['target'], lineItemFacet['entityType'], oDataServiceAVT, lineItemId, common_1.DefinitionName.ObjectPageTableColumn, common_1.DefinitionName.CustomColumnOP, common_1.DefinitionName.CustomActionOP);
...
function handleHeaderFacet(facet, facetKey, sections, appSchema, facetDefinitionKey) {
    ...
    sectionFacet[common_1.SchemaTag.dataType] = common_1.determineDataTypeOfTarget(facet === null || facet === void 0 ? void 0 : facet.target);
...
function handleSectionPresentationVariant(facet, facetKey, appSchema, sections, generateParameters, v4Page) {
    ...
    if (visualizations === null || visualizations === void 0 ? void 0 : visualizations[0]) {
...
function addSections(generateParameters, appSchema, v4Page) {
    ...
    const facets = common_1.getObjectPageFacets(generateParameters.entitySet.entityType, generateParameters === null || generateParameters === void 0 ? void 0 : generateParameters.serviceAVT, ux_specification_types_1.FioriElementsVersion.v4, generateParameters.logger);
    if (!facets) {
    ...
    if (appSchema.definitions[common_1.DefinitionName.CustomSections]) {
        sections.properties = Object.assign(Object.assign({}, sections.properties), appSchema.definitions[common_1.DefinitionName.CustomSections].properties);
    }
}
/**
...
function addHeaderSections(generateParameters, appSchema, entityType, v4Page) {
    // Get facet annotations
    const facets = common_1.getObjectPageHeaderFacets(entityType, generateParameters === null || generateParameters === void 0 ? void 0 : generateParameters.serviceAVT, ux_specification_types_1.FioriElementsVersion.v4, generateParameters.logger);
...
function addRelatedFacetKeysType(generateParameters, schema, entitySetName, pages) {
    Object.keys(pages).forEach((element) => {
        if (pages[element].options &&
            ...
            const facetSections = common_1.getObjectPageFacetSection(generateParameters.entitySet.entityType, generateParameters === null || generateParameters === void 0 ? void 0 : generateParameters.serviceAVT, generateParameters.logger);
...
function addHeader(generateParameters, appSchema, v4Page) {
    ...
    // Add header actions
    common_1.addHeaderActions(appSchema, entityType, generateParameters === null || generateParameters === void 0 ? void 0 : generateParameters.serviceAVT, addHeaderActionCallBackV4);
    // Add header sections
