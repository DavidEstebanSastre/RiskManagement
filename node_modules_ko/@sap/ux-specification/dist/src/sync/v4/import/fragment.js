...
function readHeaderFacetExtensions(manifest, target, appId, fragmentFiles) {
    ...
    for (const pageKey in targets) {
        if (pageKey === target) {
            const targetSettings = (_a = targets[pageKey].options) === null || _a === void 0 ? void 0 : _a.settings;
            // Read extensions for header facets
            const configBasedFacets = (_c = (_b = targetSettings === null || targetSettings === void 0 ? void 0 : targetSettings.controlConfiguration) === null || _b === void 0 ? void 0 : _b[`@${"com.sap.vocabularies.UI.v1.HeaderFacets" /* HeaderFacets */}`]) === null || _c === void 0 ? void 0 : _c.facets;
            const contentBasedFacets = (_e = (_d = targetSettings === null || targetSettings === void 0 ? void 0 : targetSettings.content) === null || _d === void 0 ? void 0 : _d.header) === null || _e === void 0 ? void 0 : _e.facets;
...
function readSectionExtensions(manifest, target, appId, fragmentFiles) {
    ...
    for (const pageKey in targets) {
        if (pageKey === target) {
            ...
            const contentBasedSections = (_c = (_b = targetSettings === null || targetSettings === void 0 ? void 0 : targetSettings.content) === null || _b === void 0 ? void 0 : _b.body) === null || _c === void 0 ? void 0 : _c.sections;
            const configBasedSections = (_e = (_d = targetSettings === null || targetSettings === void 0 ? void 0 : targetSettings.controlConfiguration) === null || _d === void 0 ? void 0 : _d[`@${"com.sap.vocabularies.UI.v1.Facets" /* Facets */}`]) === null || _e === void 0 ? void 0 : _e.sections;
