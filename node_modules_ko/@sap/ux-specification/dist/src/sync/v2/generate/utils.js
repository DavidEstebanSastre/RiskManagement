...
function addCustomColumnDefinition(appSchema, customColumnsDefinitionName, customColumnDefinitionName) {
    if (appSchema.definitions[common_1.DefinitionName.LineItems]) {
        appSchema.definitions[common_1.DefinitionName.LineItems]['properties']['custom'] = {
    ...
    for (const id in columnDefinition.properties) {
        columnDefinition.properties[id][common_1.SchemaTag.artifactType] = ux_specification_types_1.ArtifactType.Manifest;
    }
}
/**
...
function handleActionRecord(appSchema, actions, lineItemProps, actionType, recordIndex) {
    ...
    const actionTemplate = lineItemProps.lineItemId === common_1.DefinitionName.LineItems ? '' : 'ObjectPage';
...
function getColumnActionType(lineItemId, lineItemRecord, actionTypes) {
    if (lineItemId !== common_1.DefinitionName.LineItems &&
...
function addLineItemsType(appSchema, lineItemAnnotation, entityType, lineItemId, customColumnRef) {
    ...
    lineItemId = lineItemId || common_1.DefinitionName.LineItems;
