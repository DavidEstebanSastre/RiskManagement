...
function generateAnalyticalListReportSchemaV2(generateParameters, genericSchema, entityTypeName) {
    ...
    appSchema.properties[common_1.PropertyName.table].anyOf[0]['$ref'] =
    ...
    tableDefinitionResponsive.properties['columns']['$ref'] = `${common_1.DEFINITION_LINK_PREFIX}${common_1.DefinitionName.LineItems}`;
    ...
    appSchema.properties[common_1.PropertyName.table]['anyOf'][1]['$ref'] = `${common_1.DEFINITION_LINK_PREFIX}ALPGridTable<LineItems>`;
    const tableDefinitionGrid = JSON.parse(JSON.stringify(appSchema['definitions']['ALPGridTable']));
    tableDefinitionGrid.properties['columns']['$ref'] = `${common_1.DEFINITION_LINK_PREFIX}${common_1.DefinitionName.LineItems}`;
    ...
    appSchema.properties[common_1.PropertyName.table]['anyOf'][2]['$ref'] = `${common_1.DEFINITION_LINK_PREFIX}ALPAnalyticalTable<LineItems>`;
    const tableDefinitionAnalytical = JSON.parse(JSON.stringify(appSchema.definitions['ALPAnalyticalTable']));
    tableDefinitionAnalytical.properties['columns']['$ref'] = `${common_1.DEFINITION_LINK_PREFIX}${common_1.DefinitionName.LineItems}`;
