...
function importFilterBar(listReportConfig, factory, importParameters, schemaDefinitions, pageKey) {
    listReportConfig.filterBar = factory.createInstance(ux_specification_types_1.PageType.ListReport, common_1.DefinitionName.ListReportFilterBar, listReportConfig.filterBar);
    index_1.transferSettingsOfObject(listReportConfig.filterBar, importParameters.manifest, schemaDefinitions[common_1.DefinitionName.ListReportFilterBar], pageKey, importParameters.logger);
    if (schemaDefinitions['SelectionFields']) {
        listReportConfig.filterBar.selectionFields = factory.createInstance(ux_specification_types_1.PageType.ListReport, common_1.DefinitionName.ListReportFilterBar, listReportConfig.filterBar.selectionFields);
...
function importTable(tableType, schemaDefinitions, listReportConfig, importParameters, pageKey) {
    ...
    if (tableType === 'TreeTable' || tableType === 'AnalyticalTable' || tableType === 'GridTable') {
        ...
        if (schemaDefinitions[types_1.MULTISELECTTABLE] && schemaDefinitions[types_1.INLINEDELETETABLE]) {
            ...
            localJsonSchema.properties = Object.assign(Object.assign({}, localJsonSchema.properties), schemaDefinitions[types_1.INLINEDELETETABLE].properties);
        }
    }
...
function addSettings(importParameters, listReportConfig, factory, pageKey) {
    ...
    //Import ToolBar:
    listReportConfig.table.toolBar = factory.createInstance(ux_specification_types_1.PageType.ListReport, common_1.DefinitionName.ToolBar, {
        actions: {}
    });
    index_1.transferSettingsOfObject(listReportConfig.table.toolBar, importParameters.manifest, schemaDefinitions[common_1.DefinitionName.ToolBarLR], pageKey, importParameters.logger);
    if (schemaDefinitions[common_1.DefinitionName.ActionsLR]) {
        for (const actionProperty in schemaDefinitions[common_1.DefinitionName.ActionsLR].properties) {
            ...
            listReportConfig.table.toolBar.actions[actionKey] = factory.createInstance(ux_specification_types_1.PageType.ListReport, common_1.DefinitionName.Action);
            index_1.transferSettingsOfObject(listReportConfig.table.toolBar.actions[actionKey], importParameters.manifest, schemaDefinitions[common_1.DefinitionName.Action], pageKey, importParameters.logger);
        }
    }
    //Import FilterBar:
    ...
    if (footerAction) {
        for (const actionProperty in footerAction.properties) {
            const actionKey = index_1.convertActionKey(actionProperty);
            listReportConfig.footer.actions[actionKey] = factory.createInstance(ux_specification_types_1.PageType.ListReport, common_1.DefinitionName.FooterAction);
            index_1.transferSettingsOfObject(listReportConfig.footer.actions[actionKey], importParameters.manifest, schemaDefinitions[common_1.DefinitionName.Action], pageKey, importParameters.logger);
        }
    }
}
/**
