...
function filterActions(definitionType, jsonSchema) {
    ...
    actions.forEach((definitionActionId) => {
        var _a;
        const fullActionId = common_1.convertActionKeyToStableId((_a = definitionActionId.split('<')[1]) === null || _a === void 0 ? void 0 : _a.split('>')[0]);
...
function addActionFlex(config, changePropertyKey, change, jsonSchema) {
    ...
    actionTypes.forEach((action) => {
        ...
        if (schemaActions.has(action.id)) {
            ...
            const configId = (_a = referenceId.split('<')[1]) === null || _a === void 0 ? void 0 : _a.split('>')[0];
            ...
            const schemaProperty = (_b = jsonSchema.definitions[referenceId]) === null || _b === void 0 ? void 0 : _b.properties[changePropertyKey];
...
function addSmartChartFlex(config, changePropertyKey, change, jsonSchema) {
    ...
    if (schemaProperty) {
        const syncRule = decorators_1.getReflectMetadata(config[common_1.PropertyName.chart], changePropertyKey);
        if ((_a = syncRule === null || syncRule === void 0 ? void 0 : syncRule.flex) === null || _a === void 0 ? void 0 : _a.importFlexValue) {
            syncRule.flex.importFlexValue(change, config[common_1.PropertyName.chart], changePropertyKey);
        }
        else {
            config[common_1.PropertyName.chart][changePropertyKey] = change.content.newBinding
                ? change.content.newBinding
                : change.content.newValue;
        }
    }
...
function addFlex(config, changeString, appSchema, logger) {
    ...
    try {
        ...
        if (((_a = change.controlId) === null || _a === void 0 ? void 0 : _a.includes(ux_specification_types_1.PageType.ListReport)) || ((_b = change.controlId) === null || _b === void 0 ? void 0 : _b.includes(ux_specification_types_1.PageType.AnalyticalListPage))) {
...
function analzyeFilteredFragments(filteredFragments, config, viewExtensionsOfPage, manifestKey, keyTab, extensionType, cellsFragmentName) {
    ...
    if (filteredFragments[0]) {
        ...
        if (columnDefinition) {
            if (!((_a = config[common_1.PropertyName.table]) === null || _a === void 0 ? void 0 : _a['columns'])) {
                config[common_1.PropertyName.table]['columns'] = {};
            }
