...
exports.getCreationFieldsPathV2 = (pageKeys, key) => {
...
exports.getKPISettingsPath = (pageKeys, kpiKey) => {
...
exports.getAppSettingOBJsectionPathV2 = (pageKeys, _manifest, sectionId) => {
    const pathParts = [];
    pathParts.push(exports.getAppRootSettingOBJPath(pageKeys));
...
exports.getTableSettingsOBJsectionPathV2 = (pageKeys, _manifest, sectionId) => {
    const path = exports.getAppSettingOBJsectionPathV2(pageKeys, {}, sectionId);
    return path + '/tableSettings';
};
exports.getChartSettingsOBJsectionPathV2 = (pageKeys, _manifest, sectionId) => {
    const path = exports.getAppSettingOBJsectionPathV2(pageKeys, {}, sectionId);
...
exports.getObjectPageCustomSectionPath = (pageName, _manifest, sectionId, ...pathParts) => {
    const separator = '|';
