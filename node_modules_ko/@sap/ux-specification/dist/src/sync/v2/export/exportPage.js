...
function getSubsectionClasses(currentSection, factory) {
    if (currentSection === null || currentSection === void 0 ? void 0 : currentSection['subsections']) {
        let subSection;
...
const exportApplicationV2 = (application, manifest, jsonSchema) => {
    ...
    const manifestPages = (_a = exportResults.manifest[ux_specification_types_1.ManifestSection.generic]) === null || _a === void 0 ? void 0 : _a.pages;
