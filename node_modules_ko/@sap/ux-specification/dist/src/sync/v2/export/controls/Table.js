...
exports.getSmartTableControlId = (baseId, idBreadcrumbs, _breadcrumbs, controlType) => {
    if (controlType() === 'sap.m.Table') {
        ...
        return baseId + common_1.PropertyName.table;
    }
...
function importMultiEdit(manifestSection) {
    ...
    configPart.ignoredFields = (_b = (_a = manifestSection['multiEdit']) === null || _a === void 0 ? void 0 : _a['ignoredFields']) === null || _b === void 0 ? void 0 : _b.split(',');
    return configPart;
}
...
function importType(manifestSection) {
    var _a;
    if ((_a = manifestSection === null || manifestSection === void 0 ? void 0 : manifestSection['tableSettings']) === null || _a === void 0 ? void 0 : _a['type']) {
        return manifestSection['tableSettings']['type'];
    }
    else if (manifestSection === null || manifestSection === void 0 ? void 0 : manifestSection['tableType']) {
        return manifestSection['tableType'];
    }
}
//export table type
function exportType(manifestSection, configPart) {
    if (configPart === null || configPart === void 0 ? void 0 : configPart['type']) {
        if (!manifestSection['tableSettings']) {
            manifestSection['tableSettings'] = {};
        }
        manifestSection['tableSettings']['type'] = configPart['type'];
        if (manifestSection === null || manifestSection === void 0 ? void 0 : manifestSection['tableType']) {
            //old format
...
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys) + common_1.QUICKVARPATH
        }
    }),
    decoration_1.validity({
        since: '1.48.0'
...
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys) + common_1.QUICKVARPATHX
        }
    }),
    decoration_1.validity({
        since: '1.48.0'
